<?php
/**
 * Postero WooCommerce Adjacent Products Class
 *
 * @package  postero
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Postero_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Postero WooCommerce Adjacent Products Class
	 */
	class Postero_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'postero_woocommerce_adjacent_query_args', $args ) );
