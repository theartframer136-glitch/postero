...
if ( ! function_exists( 'postero_elementor_parse_text_editor' ) ) {
	function postero_elementor_parse_text_editor( $content, $obj ) {
...
if ( ! function_exists( 'postero_elementor_get_strftime' ) ) {
	function postero_elementor_get_strftime( $instance, $obj ) {
		$string = '';
