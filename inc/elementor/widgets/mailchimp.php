...
if (!postero_is_mailchimp_activated()) {
    return;
}
...
class Postero_Elementor_Mailchimp extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'postero-mailchimp';
    }

    public function get_title()
    {
        return esc_html__('MailChimp Sign-Up Form', 'postero');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Placeholder', 'postero'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'input_color_border',
            [
                'label' => esc_html__('Color Border', 'postero'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab(
            'tab_input_focus',
            [
                'label' => esc_html__('Focus', 'postero'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Border Color hover', 'postero'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Postero_Elementor_Mailchimp());
