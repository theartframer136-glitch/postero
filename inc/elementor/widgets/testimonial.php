...
class Postero_Elementor_Testimonials extends Postero_Base_Widgets_Swiper {
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__('Postero Testimonials', 'postero');
    }
    ...
    public function get_script_depends() {
        return ['postero-elementor-testimonial', 'postero-elementor-swiper'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => esc_html__('Testimonials', 'postero'),
            ]
        );
        ...
        $repeater->add_control(
            'testimonial_rating',
            [
                'label'   => esc_html__('Rating', 'postero'),
                'default' => 5,
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    0 => esc_html__('Hidden', 'postero'),
                    1 => esc_html__('Very poor', 'postero'),
                    2 => esc_html__('Not that bad', 'postero'),
                    3 => esc_html__('Average', 'postero'),
                    4 => esc_html__('Good', 'postero'),
                    5 => esc_html__('Perfect', 'postero'),
                ]
            ]
        );
                                ...
                                <?php if ($testimonial['testimonial_rating'] && $testimonial['testimonial_rating'] > 0) {
                                    ...
                                    for ($i = 1; $i <= 5; $i++) {
                                        if ($i <= $testimonial['testimonial_rating']) {
                                            echo '<i class="postero-icon-star active" aria-hidden="true"></i>';
                                        }
                                    }
                                    echo '</div>';
                                } ?>
...
$widgets_manager->register(new Postero_Elementor_Testimonials());
