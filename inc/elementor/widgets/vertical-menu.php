...
class Postero_Elementor_Vertiacl_Menu extends Elementor\Widget_Base
{
    ...
    {
        return 'postero-vertical-menu';
    }

    public function get_title()
    {
        return esc_html__('Postero Vertical Menu', 'postero');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'nav_vertiacl_layout',
            [
                'label' => esc_html__('Menu Layout', 'postero'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'style-1' => esc_html__('Layout 1', 'postero'),
                    'style-2' => esc_html__('Layout 2', 'postero'),
                ],
                'default' => 'style-1',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation .vertical-navigation-header .postero-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Icon Hover', 'postero'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation:hover .vertical-navigation-header .postero-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sub Menu', 'postero'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Active', 'postero'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Color Hover', 'postero'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render()
    {
        ...
        <div <?php $this->print_render_attribute_string('wrapper'); ?>>
            <nav class="vertical-navigation" aria-label="<?php esc_attr_e('Vertiacl Navigation', 'postero'); ?>">
...
$widgets_manager->register(new Postero_Elementor_Vertiacl_Menu());
